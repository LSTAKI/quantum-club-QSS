...
const HeroSection = () => (
  ...
  >
    ...
    <div className="relative z-10 container text-center text-navy-foreground">
      ...
      >
        Exploring the Frontiers of Quantum Science — A student-led initiative fostering undergraduate research and collaboration.
      </motion.p>
      ...
      >
        ...
        <div className="flex items-center gap-2 text-navy-foreground/70">
          ...
          <span className="text-sm font-medium">IISER Tirupati</span>
        </div>
      </motion.div>
